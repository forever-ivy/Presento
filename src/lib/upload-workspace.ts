...
export const uploadWorkspaceMockTrayItems: UploadTrayItem[] = [
  { id: "mock:ppt", name: "答辩 PPT.pdf", size: 2.4 * 1024 * 1024, status: "completed" },
  { id: "mock:script", name: "答辩原稿.pptx", size: 6.2 * 1024 * 1024, status: "completed" },
  { id: "mock:report", name: "项目报告.pdf", size: 1.8 * 1024 * 1024, status: "completed" },
  { id: "mock:zip", name: "backend.zip", size: 4.9 * 1024 * 1024, status: "uploading", progress: 62 },
  { id: "mock:sql", name: "orders.sql", size: 188 * 1024, status: "completed" },
  { id: "mock:xlsx", name: "订单数据.xlsx", size: 512 * 1024, status: "queued", progress: 0 },
  {
    id: "mock:review",
    name: "风险追问清单.md",
    size: 96 * 1024,
...
export function buildUploadWorkspaceCopy(variant: UploadWorkspaceVariant): UploadWorkspaceCopy {
  if (variant === "workspace") {
    return {
      ...
      title: "继续上传课程项目资料",
      description: "",
      dropzoneLabel: "拖拽资料到这里，或点击继续选择文件",
      dropzoneHint: "",
  ...
  return {
    ...
    dropzoneLabel: "拖拽课程项目资料，或点击选择文件",
